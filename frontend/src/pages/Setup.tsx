...
export default function Setup() {
  ...
  async function completeSetup() {
    ...
    try {
      ...
      // Use replace to ensure the setup page is removed from history
    ...
    <div style={{ 
      ...
      <div className="card" style={{ 
        ...
        <p style={{ color: 'var(--muted)', marginBottom: 32 }}>
          Welcome! Let's set up your school management system.
        </p>
          ...
          <div>
            ...
            <div style={{ marginBottom: 24, textAlign: 'left' }}>
              ...
              <div style={{ fontSize: '0.9em', color: 'var(--muted)', marginTop: 4 }}>
                This will replace "School Master" throughout the system
              </div>
            </div>
        ...
        {step === 3 && setupType === 'new' && (
          <div>
            <h2 style={{ color: 'var(--text)', marginBottom: 24 }}>Step 3: Admin Password</h2>
        ...
        {step === 4 && setupType === 'new' && (
          <div>
            <h2 style={{ color: 'var(--text)', marginBottom: 24 }}>Step 4: School Logo (Optional)</h2>
